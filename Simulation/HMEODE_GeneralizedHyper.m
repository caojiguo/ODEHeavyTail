% Simulation 1
% Random effects were generated from the generalized hyperbolic
% distribution with parameters (mu=0,delta=1,alpha=5,beta=0,lambda=1);
...
load('GHtheta1Sam.mat');
load('GHtheta2Sam.mat');
load('GHX0Sam.mat');
...
for tt=1:Nreps
    ...
    thetaImat(1,:) = GHtheta1Sam(:,tt)';
    thetaImat(2,:) = GHtheta2Sam(:,tt)';
