...
% A half-normal prior distribution is assigned on the standard deviation
% parameter.
...
input1.oldscale_sigmaE = oldscale_sigmaE;
...
input1.countsigmaE = countsigmaE;

input1.options1 = options1;

out1 = HalfNormal_MCMC_funTT(input1);
...
out1 = HalfNormal_MCMC_funNN(input1);
